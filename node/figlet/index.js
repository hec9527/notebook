...
// console.log(figlet.textSync('So sorry about that', { horizontalLayout: 'fitted' }));
console.log(figlet.textSync('RongShuWeb', { horizontalLayout: 'fitted' }));

// console.log(figlet.textSync('BattleCity', { horizontalLayout: 'fitted' }));
