...
- [百度 FAQ 自动问答系统](https://github.com/baidu/AnyQ)
...
- 半自动安装：先下载 [下载地址](http://pypi.python.org/pypi/jieba/) ，解压后运行 `python setup.py install`
...
- "通过用户自定义词典来增强歧义纠错能力" --- [issues](https://github.com/fxsjy/jieba/issues/14)
